...
/* fonctions qui gère les matchs */
	...
	$query = $this->db->query("CALL supp_match('$code');");
	/*test de bon execution requette*/ 
	...
	$query = $this->db->query("UPDATE T_MATCH_MAT SET MAT_ACTIF='$activ' WHERE MAT_CODE='$code'  ;");
	/*test de bon execution requette*/ 
	return ($query);
	}
...
/* fonctions qui gère les joueurs */
	...
	public function set_score_joueur($score,$pseudo){
		$query = $this->db->query("UPDATE T_JOUEUR_JOU SET JOU_SCORE=$score WHERE JOU_PSEUDO='$pseudo';");
	}
