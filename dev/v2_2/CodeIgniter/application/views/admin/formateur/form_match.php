...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Description :
// affichage du match dans la partie formateur gestion des match
//-------------------------------------------------------------
// A noter :
// on y accède grace au lien hypertext dans le tableau
//===============================================================-->
...
<div class="section-content">
 <table class="table table-hover">
    ...
    <?php if($m['MAT_FIN']==null){
        ?><button class="btn btn-primary" type="submit" name="desactivation" value=""> Terminer </button><br><br><?php //ne marche pas
        ?><button class="btn btn-primary" type="submit" name="desactivation" href="<?php echo base_url();?>index.php/formateur/gestion" value=""> Retour </button><?php
    }
    else{
