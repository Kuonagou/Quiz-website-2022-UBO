...
public function afficher($donne=NULL)
{
	if($donne){
		$data['match']=$this->db_model->get_all_info_match_donne($donne);
		$this->load->view('haut');
		...
		$this->form_validation->set_rules('pseudo', 'pseudo', 'trim|required|alpha_numeric', array('required'=>'Veuillez saisir un pseudo !','alpha_numeric'=>'que des chiffres et des lettres'));
