...
/* fonctions qui gère les matchs */
	...
	public function activ($code){
 
	
	$query = $this->db->query("UPDATE T_QUIZ_QUI join T_MATCH_MAT using(QUI_ID) SET QUI_ACTIF='1' WHERE MAT_CODE='$code'  ;");
	/*test de bon execution requette*/ 

	}
	public function desactiv($code){
 
	$query1 = $this->db->query("UPDATE T_QUIZ_QUI join T_MATCH_MAT using(QUI_ID) SET QUI_ACTIF='0' WHERE MAT_CODE='$code';");
	/*test de bon execution requette*/ 
