                    ...
                    foreach($match1 as $m){
                        ...
                        <tr>
                            ...
                            <th><?php if($m['QUI_ACTIF'] == 1){
                                ?><button class="btn btn-primary" type="submit" name="activation" value="<?php echo $m["MAT_CODE"];?>">désactiver</button><?php
                            }
                            else{
                                ?><button class="btn btn-primary" type="submit" name="desactivation" value="<?php echo $m["MAT_CODE"];?>">activer</button><?php
                            }?></th></form>
