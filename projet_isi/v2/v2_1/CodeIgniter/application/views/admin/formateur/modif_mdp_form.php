<div class="colr-area">
    <div class="container">
        <div class="col-md-4" data-aos="fade-up">
                ...
                <?php echo form_open('modif_mdp_form'); ?>
                <div class="row">
                ...
                <br>
                <input class="btn  btn-shadow btn-lg" href="<?php echo base_url();?>index.php/formateur/afficher" type="submit" name="submit" value="Supprimer" />
                </div>
            </div>
        </div>
    </div>
